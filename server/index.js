...
// All data from the frontend's `mockData.ts` has been moved here.
const mockUsers = [
...
// --- API Routes ---
app.get('/', (req, res) => {
  res.send('SmartEarning Backend Server is running!');
});

// Endpoint for each data type
app.get('/api/users', (req, res) => res.json(mockUsers));
app.get('/api/deposits', (req, res) => res.json(mockDeposits));
app.get('/api/withdrawals', (req, res) => res.json(mockWithdrawals));
app.get('/api/payment-methods', (req, res) => res.json(mockPaymentMethods));
app.get('/api/investment-plans', (req, res) => res.json(mockInvestmentPlans));
app.get('/api/transfers', (req, res) => res.json(mockTransfers));
app.get('/api/transactions', (req, res) => res.json(mockTransactions));
app.get('/api/rules', (req, res) => res.json(mockRules));
