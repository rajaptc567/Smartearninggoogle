...
const reportConfigs: { [key in ReportType]: { label: string; key: keyof any }[] } = {
    ...
    // FIX: Changed key from 'activePlan' to 'activePlans' to match the User type definition.
    users: [ { label: 'ID', key: 'id' }, { label: 'Username', key: 'username' }, { label: 'Full Name', key: 'fullName' }, { label: 'Email', key: 'email' }, { label: 'Active Plan(s)', key: 'activePlans' }, { label: 'Status', key: 'status' }, { label: 'Registration Date', key: 'registrationDate' }, ],
