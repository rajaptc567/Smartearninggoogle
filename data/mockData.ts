import { User, Deposit, Withdrawal, PaymentMethod, InvestmentPlan, Transaction, Rule, Transfer, Notification, Settings, Status } from '../types';
...
export const mockInvestmentPlans: InvestmentPlan[] = [
        { id: 1, name: 'Bronze Plan', price: 50, durationDays: 30, minWithdraw: 10, description: 'A great starting plan.', status: Status.Active, directReferralLimit: 10, directCommissions: Array(10).fill(null).map((_, i) => ({ type: 'percentage', value: i < 5 ? 10 : 8 })), indirectCommissions: [ { type: 'percentage', value: 5 }, { type: 'percentage', value: 2 }, ], commissionDeductions: { afterMaxPayout: { type: 'fixed', value: 10 }, afterMaxEarning: { type: 'fixed', value: 10 }, afterMaxDirect: { type: 'fixed', value: 5 }, }, autoUpgrade: { enabled: true, toPlanId: 2 }, holdPosition: { enabled: true, slots: [9, 10] }, },
        { id: 2, name: 'Silver Plan', price: 100, durationDays: 60, minWithdraw: 25, description: 'Balanced plan for steady growth.', status: Status.Active, directReferralLimit: 20, directCommissions: Array(20).fill({ type: 'fixed', value: 25 }), indirectCommissions: [ { type: 'fixed', value: 10 }, { type: 'fixed', value: 5 }, { type: 'fixed', value: 2 }, ], commissionDeductions: { afterMaxPayout: { type: 'percentage', value: 5 }, afterMaxEarning: { type: 'percentage', value: 5 }, afterMaxDirect: { type: 'percentage', value: 2 }, }, autoUpgrade: { enabled: true, toPlanId: 3 }, holdPosition: { enabled: false, slots: [] }, },
        { id: 3, name: 'Gold Plan', price: 200, durationDays: 0, minWithdraw: 100, description: 'Premium plan for maximum returns. Never expires.', status: Status.Active, directReferralLimit: 0, directCommissions: [{ type: 'percentage', value: 15 }], indirectCommissions: [ { type: 'percentage', value: 7 }, { type: 'percentage', value: 3 }, { type: 'percentage', value: 1 }, { type: 'percentage', value: 0.5 }, ], commissionDeductions: { afterMaxPayout: { type: 'fixed', value: 0 }, afterMaxEarning: { type: 'fixed', value: 0 }, afterMaxDirect: { type: 'fixed', value: 0 }, }, autoUpgrade: { enabled: false }, holdPosition: { enabled: false, slots: [] }, },
        { id: 4, name: 'Starter (Old)', price: 25, durationDays: 15, minWithdraw: 5, description: 'This plan is no longer available.', status: Status.Disabled, directReferralLimit: 5, directCommissions: Array(5).fill({ type: 'fixed', value: 5 }), indirectCommissions: [], commissionDeductions: { afterMaxPayout: { type: 'fixed', value: 0 }, afterMaxEarning: { type: 'fixed', value: 0 }, afterMaxDirect: { type: 'fixed', value: 0 }, }, autoUpgrade: { enabled: false }, holdPosition: { enabled: false, slots: [] }, },
    ];
